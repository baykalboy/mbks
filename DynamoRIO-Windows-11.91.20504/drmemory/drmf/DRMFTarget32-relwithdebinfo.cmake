...
list(APPEND _cmake_import_check_files_for_drmemory_annotations "${_IMPORT_PREFIX}/drmemory/drmf/lib32/release/drmemory_annotations.lib" )

# Import target "drmf_drsyscall" for configuration "RelWithDebInfo"
set_property(TARGET drmf_drsyscall APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(drmf_drsyscall PROPERTIES
  IMPORTED_IMPLIB_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmemory/drmf/lib32/release/drmf_drsyscall.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELWITHDEBINFO "ntdll_imports"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmemory/drmf/lib32/release/drmf_drsyscall.dll"
  )

list(APPEND _cmake_import_check_targets drmf_drsyscall )
list(APPEND _cmake_import_check_files_for_drmf_drsyscall "${_IMPORT_PREFIX}/drmemory/drmf/lib32/release/drmf_drsyscall.lib" "${_IMPORT_PREFIX}/drmemory/drmf/lib32/release/drmf_drsyscall.dll" )

# Import target "drmf_drsyscall_static" for configuration "RelWithDebInfo"
set_property(TARGET drmf_drsyscall_static APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(drmf_drsyscall_static PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELWITHDEBINFO "ntdll_imports"
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "C;CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmemory/drmf/lib32/release/drmf_drsyscall_static.lib"
  )

list(APPEND _cmake_import_check_targets drmf_drsyscall_static )
list(APPEND _cmake_import_check_files_for_drmf_drsyscall_static "${_IMPORT_PREFIX}/drmemory/drmf/lib32/release/drmf_drsyscall_static.lib" )
...
list(APPEND _cmake_import_check_files_for_drsymcache "${_IMPORT_PREFIX}/drmemory/drmf/lib32/release/drsymcache.lib" "${_IMPORT_PREFIX}/drmemory/drmf/lib32/release/drsymcache.dll" )
...
list(APPEND _cmake_import_check_files_for_drsymcache_static "${_IMPORT_PREFIX}/drmemory/drmf/lib32/release/drsymcache_static.lib" )
...
list(APPEND _cmake_import_check_files_for_umbra "${_IMPORT_PREFIX}/drmemory/drmf/lib32/release/umbra.lib" "${_IMPORT_PREFIX}/drmemory/drmf/lib32/release/umbra.dll" )
...
list(APPEND _cmake_import_check_files_for_umbra_static "${_IMPORT_PREFIX}/drmemory/drmf/lib32/release/umbra_static.lib" )
...
list(APPEND _cmake_import_check_files_for_drfuzz "${_IMPORT_PREFIX}/drmemory/drmf/lib32/release/drfuzz.lib" "${_IMPORT_PREFIX}/drmemory/drmf/lib32/release/drfuzz.dll" )
...
list(APPEND _cmake_import_check_files_for_drfuzz_static "${_IMPORT_PREFIX}/drmemory/drmf/lib32/release/drfuzz_static.lib" )
